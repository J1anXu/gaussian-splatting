...
#   MERGE_FAST_VALIDATE_FATAL=1 bash test_4090.sh
#
...
MERGE_FAST_VALIDATE_EVERY="${MERGE_FAST_VALIDATE_EVERY:-1}"
MERGE_FAST_VALIDATE_UNTIL="${MERGE_FAST_VALIDATE_UNTIL:-750}"
MERGE_FAST_VALIDATE_ATOL="${MERGE_FAST_VALIDATE_ATOL:-1e-5}"
MERGE_FAST_VALIDATE_BG_ATOL="${MERGE_FAST_VALIDATE_BG_ATOL:-1e-5}"
MERGE_FAST_VALIDATE_MAX_PRINT="${MERGE_FAST_VALIDATE_MAX_PRINT:-20}"
MERGE_FAST_VALIDATE_FATAL="${MERGE_FAST_VALIDATE_FATAL:-0}"
...
export MERGE_FAST
export MERGE_FAST_MAX_K
export MERGE_FAST_VALIDATE
export MERGE_FAST_VALIDATE_EVERY
export MERGE_FAST_VALIDATE_UNTIL
export MERGE_FAST_VALIDATE_ATOL
export MERGE_FAST_VALIDATE_BG_ATOL
export MERGE_FAST_VALIDATE_MAX_PRINT
export MERGE_FAST_VALIDATE_FATAL
...

{
  ...
  log "MERGE_FAST=$MERGE_FAST MERGE_FAST_MAX_K=$MERGE_FAST_MAX_K"
  log "MERGE_FAST_VALIDATE=$MERGE_FAST_VALIDATE every=$MERGE_FAST_VALIDATE_EVERY until=$MERGE_FAST_VALIDATE_UNTIL atol=$MERGE_FAST_VALIDATE_ATOL bg_atol=$MERGE_FAST_VALIDATE_BG_ATOL max_print=$MERGE_FAST_VALIDATE_MAX_PRINT fatal=$MERGE_FAST_VALIDATE_FATAL"
